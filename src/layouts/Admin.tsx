...
import Rarities from '../views/Home/components/pages/Rarities';
import Claim from '../views/Home/components/pages/Claim'
import Inv from '../views/Home/components/pages/Claim'
